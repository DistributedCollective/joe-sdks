...
export const MULTICALL_ADDRESS: { [chainId in ChainId]: Hex } = {
  ...
  [ChainId.BOB_TESTNET_LEGACY]: '0xcA11bde05977b3631167028862bE2a173976CA11',
  [ChainId.BOB_TESTNET]: '0x43aCeB7846d580877D2B98A6c3b0ea51a39a62A4'
}
...
export const LB_QUOTER_ADDRESS: { [chainId in ChainId]: Hex } = {
  ...
  [ChainId.BOB_TESTNET_LEGACY]: '0x0000000000000000000000000000000000000000',
  [ChainId.BOB_TESTNET]: '0x0000000000000000000000000000000000000000'
}
...
export const LB_QUOTER_V22_ADDRESS: { [chainId in ChainId]: Hex } = {
  ...
  [ChainId.BOB_TESTNET_LEGACY]: '0x0000000000000000000000000000000000000000',
  [ChainId.BOB_TESTNET]: '0x55e530dc7741DeeaC356F25179a0aC6dc917949c'
}
...
export const LB_ROUTER_V22_ADDRESS: { [chainId in ChainId]: Hex } = {
  ...
  [ChainId.BOB_TESTNET_LEGACY]: '0x0000000000000000000000000000000000000000',
  [ChainId.BOB_TESTNET]: '0xC2Af3934F01FAFBD780e9BD572c9DC711A163cdc'
}
...
export const LB_FACTORY_V22_ADDRESS: { [chainId in ChainId]: Hex } = {
  ...
  [ChainId.BOB_TESTNET_LEGACY]: '0x603764D0D819C50a6A9aab009410ABAC6482C874',
  [ChainId.BOB_TESTNET]: '0x7a6cBEbcB12095f32D620E0970A22F8635946D15'
}
