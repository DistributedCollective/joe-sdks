...
describe('Pair', () => {
      ...
      expect(
        () =>
          new Pair(
            ...
            new TokenAmount(WAVAX[ChainId.AVALANCHE], '100'),
            ChainId.FUJI
          )
      ).toThrow('CHAIN_IDS')
    })
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(Pair.getAddress(USDT, JOE, ChainId.FUJI)).toEqual(
        '0xd520cF33C013909AFc9Cf158D73F5460753B5ec4'
      )
    })
    it('returns the correct address - arb goerli', () => {
      expect(Pair.getAddress(gUSDT, gUSDC, ChainId.ARB_GOERLI)).toEqual(
        '0x682d5A31C8BDf110657d92F78467D196007749e3'
      )
    })
  })
    ...
    it('works', () => {
      ...
      expect(
        new Pair(
          ...
          new TokenAmount(USDT, '100'),
          ChainId.FUJI
        ).involvesToken(WAVAX[ChainId.FUJI])
      ).toEqual(false)
    })
  })
})
